...
async function register(event) {
  ...
  const res = await postPublicResource('https://favorable-horses-250ddbd43e.strapiapp.com/api/auth/local/register', {
...
async function login(event) {
  ...
  try {
    const res = await postPublicResource('https://favorable-horses-250ddbd43e.strapiapp.com/api/auth/local', {
