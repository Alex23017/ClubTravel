...
export interface ApiListHotelListHotel extends Struct.CollectionTypeSchema {
  collectionName: 'list_hotels'
  info: {
    displayName: 'ListHotel'
    pluralName: 'list-hotels'
    singularName: 'list-hotel'
  }
  options: {
    draftAndPublish: true
  }
