...
import{_}from"./main2.js";import{g as f}from"./listHotel.js";/* empty css             *//* empty css     */import"./variables.js";import"./api.js";import"./skeleton.js";document.querySelector('[data-component="listHotDeals"]')&&(_(()=>Promise.resolve({}),__vite__mapDeps([0])),_(()=>Promise.resolve({}),__vite__mapDeps([1])));const h=await f();function g(s){const t=s.target.closest(".href__button-select");if(!t)return;const e=t.dataset.id;e&&(window.location.href=`/html/pages/oneHotel.html?id=${e}`)}const a=document.querySelector(".hotdeals__render"),n=document.querySelector(".hotdeals__render-mob");a&&a.addEventListener("click",g);function y(){if(!a||!n)return;const s=t=>{let e="";for(let l=0;l<t;l++)e+='<svg class="hotdeals__category-star"><use xlink: href = "#icon-star-shiny" ></ ></svg > ';return e};h.forEach(t=>{const e=t.img[0].url,l=t.openList.map(o=>{const v=(o.openListSelect||[]).map(i=>`
