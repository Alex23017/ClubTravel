...
function requireRu() {
  ...
  (function(module, exports$1) {
    (function(global, factory) {
      ...
      fp.l10ns.ru = Russian;
      var ru2 = fp.l10ns;
      exports$12.Russian = Russian;
      exports$12.default = ru2;
...
function renderPackage() {
  ...
  regionContainer.innerHTML = packageTour.map(
    ({ id, label, value }) => `
...
function renderFood() {
  ...
  if (!regionContainer) return;
  regionContainer.innerHTML = foodTour.map(
    ({ id, label, value }) => `
...
function renderRegions() {
  ...
  if (!regionContainer) return;
  regionContainer.innerHTML = regions.map(
    ({ id, label, value }) => `
...
function renderFlyFrom() {
  const regionContainer = document.querySelector(".advance__fly");
  if (!regionContainer) return;
  regionContainer.innerHTML = flyFrom.map(
    ({ id, label, value }) => `
